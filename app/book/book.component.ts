...
export class BookComponent implements OnInit {
    ...
    constructor( public _langCodesService: LangCodesService, public _httpService : HTTPTestService,private router: Router) {//_langCodesService is an object of LangCodesService
